...
export function DocumentsPage() {
  ...
  return (
    <div className="grid gap-6 lg:grid-cols-[320px_minmax(0,1fr)]">
      <SectionCard title="Required documents" eyebrow="Documents" description="Each record comes from the backend-required document set.">
        <div className="space-y-3">
          {documentsQuery.data?.map((doc) => (
            ...
            >
              <div>
                <p className="text-sm font-semibold text-[var(--ink)]">{doc.doc_type}</p>
      ...
      <SectionCard
        title={selectedDocType ? `Document detail: ${selectedDocType}` : 'Document detail'}
            ...
            <Stepper
              items={[
                ...
                },
                {
                  ...
                  description: 'Request a supplier declaration if the backend indicates an evidence blocker.',
